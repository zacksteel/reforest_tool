...
This document outlines some recent advances in reforestation strategies in an age of climate change and altered disturbance regimes. We rely heavily on the 2019 [*Tamm Review: Reforestation for resilience in dry western U. S. forests*](https://www.sciencedirect.com/science/article/pii/S0378112718313161?via%3Dihub) by North et al, which readers are encouraged to review for further details. For brevity, conventional reforestation practices are not covered here. It is our hope that practitioners will incorporate these state of the science strategies with previously established forestry knowledge and tailor solutions for each unique project.  
...
5 - Future Site Suitability 

6 - Example Reforestation Scenario  

7 - Potential Ecological Benefits  
...
<!-- Conifer tree seed density declines with distance from source. Where tree mortality is a result of drought and/or beetle attack, recently killed trees may serve as sources *[correct?]*. For non-serotinous species, fire-killed trees do not provide a source of seeds, and propogules must come from surviving individuals. Without more detailed information, 200m or approximately 650 feet from living trees can be used as a rough cutoff, where expected natural recruitment falls to non-existent or sparse. Recently, tools have been developed to assess natural recruitment potential in the field and using geospatial information. If utilized such tools can better delineate areas that are likely to experience natural reforestation (zone 1) from those where active management may be necessary (zone 2).   -->

<!-- In addition to active reforestation often being unnecessary where living seed sources exist, the scale of mortality events are increasing. With limited funds available, it may be unfeasible to actively reforest all areas outside of zone 1 and there may be areas where non-forest vegetation communities are desirable for ecological or other purpose (i.e. zone 3). For example, zone 3 may include areas where conventional reforestation would prohibitively expensive (e.g. steep slopes and areas isolated from existing roads) or it may it may include areas that prior to the fire-suppression era likely supported meadow or mountain chaparral habitats.   -->
...
[From Marc: *Add a section on Future site suitability that addresses the same subject heading in the Tamm review paper.  The 3rd paragraph in this section is particularly useful to summarize in the BMPs section to inform managers as to how to evaluate future site suitability with climate change.

o   Since we don’t have a photo from the paper for this section, we should insert one of our own, such as the one attached (I can send higher quality version) which shows a low elevation burned landscape with advanced natural conifer regeneration most successful in the drainages and north-facing slopes, especially at higher elevations.  Or we can use some other illustration of this concept.*]

<img src="./app_data/Photos/Pilot fire panoramic2.jpg" alt="drawing" width="800"/>
...
[From Marc: *After section 5, add another section entitled Potential ecological benefits with a brief explanation followed by a bulleted list of several of the benefits of reforestation activities focused on creating lower-density, structurally heterogeneous stands (e.g., greater ecological resistance and resilience, wildlife habitat, understory plant diversity, watershed benefits).

o   I know this one is not really a BMP, but it’s good to include this information to make it clear as to the advantages of the Tamm review approach.

o   An accompanying photo, maybe showing a heterogeneous forest stand like the attached photo, is also good but not necessary.*]

<img src="./app_data/Photos/Illilouette Basin Panoramic.jpg" alt="drawing" width="800"/>
